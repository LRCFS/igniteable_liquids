...
#head(new.dat)
# plot
ggplot(new.dat, aes(x=RT, y=Area, colour=Sample)) + 
  geom_point() + 
...
all.se = summarySE(new.dat, measurevar = "Area", groupvars = c('Sample','RT'))
head(all.se)
...
# TODO - Currently only for the 'BnQ' data
all.var = apply(all.dat[,2:22], 1, var, na.rm = TRUE)
